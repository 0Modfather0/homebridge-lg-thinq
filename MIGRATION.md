# ThinQ Connect 2.2.x migration and rollback
...
3. Install the reviewed 2.2.x tarball or npm package.
...
7. Restart and verify accessory continuity, the faucet tile's On/Off power state, optional completion services, MQTT updates, and five-minute reconciliation. Apple Home does not show cycle state or remaining time in the faucet tile; use a HomeKit characteristic inspector to check the additional Valve values.
